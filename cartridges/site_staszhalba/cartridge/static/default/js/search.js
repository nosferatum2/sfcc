...
/******/ 	return __webpack_require__(__webpack_require__.s = "./cartridges/app_lyonscg/cartridge/client/default/js/search.js");
/******/ })
/************************************************************************/
/******/ ({

/***/ "./cartridges/app_lyonscg/cartridge/client/default/js/product/wishlistHeart.js":
/*!*************************************************************************************!*\
  !*** ./cartridges/app_lyonscg/cartridge/client/default/js/product/wishlistHeart.js ***!
  \*************************************************************************************/
...
/***/ "./cartridges/app_lyonscg/cartridge/client/default/js/search.js":
/*!**********************************************************************!*\
  !*** ./cartridges/app_lyonscg/cartridge/client/default/js/search.js ***!
  \**********************************************************************/
/*! no static exports found */
...
$(document).ready(function () {
  processInclude(__webpack_require__(/*! ./search/search */ "./cartridges/app_lyonscg/cartridge/client/default/js/search/search.js"));
  ...
  processInclude(__webpack_require__(/*! lyonscg/product/wishlistHeart */ "./cartridges/app_lyonscg/cartridge/client/default/js/product/wishlistHeart.js"));
  processInclude(__webpack_require__(/*! productcompare/product/compare */ "./cartridges/plugin_productcompare/cartridge/client/default/js/product/compare.js"));
});

/***/ }),

/***/ "./cartridges/app_lyonscg/cartridge/client/default/js/search/search.js":
/*!*****************************************************************************!*\
  !*** ./cartridges/app_lyonscg/cartridge/client/default/js/search/search.js ***!
  \*****************************************************************************/
/*! no static exports found */
...
var base = __webpack_require__(/*! base/search/search */ "./cartridges/app_storefront_base/cartridge/client/default/js/search/search.js");
/**
...
function parseResults(response) {
  ...
  ['.search-banner:first-of-type', '.grid-header', '.header-bar', '.header.page-title', '.product-grid', '.show-more', '.filter-bar'].forEach(function (selector) {
...
function compileSlot(product, idx) {
  var pid = product.pid;
  var name = 'pid' + idx;
  return '' + '<div class="col-3 selected-product">' + '<div class="slot" data-pid="' + pid + '">' + '<img src="' + product.imgSrc + '" />' + '<div class="close">' + '<i class="fa fa-close"></i>' + '</div>' + '</div>' + '<input type="hidden" name="' + name + '" value="' + pid + '" />' + '</div>\n';
}
/**
  ...
  if (productsToCompare.length < maxSlots) {
    ...
    for (var i = 0; i < numAvailableSlots; i++) {
      if (i === 0 && productsToCompare.length < 2) {
        html += '<div class="col-3 selected-product"><div class="slot">' + '<div class="min-products-msg">' + $('.compare-bar').data('min-products-msg') + '</div></div></div>';
      } else {
...
module.exports = {
   ...
   */
  handleCompareClick: function handleCompareClick() {
    $('div.page').on('click', '.compare input[type=checkbox]', function () {
      var pid = $(this).attr('id');
      var checked = $(this).is(':checked');
      var imgSrc = $(this).closest('.product-tile').find('.tile-image').prop('src');
   ...
   */
  deselectProductOnCompareBar: function deselectProductOnCompareBar() {
   ...
   */
  selectCheckedProducts: function selectCheckedProducts() {
    $('.product-grid').ready(function () {
      ...
      $('.compare input:checked').each(function () {
        ...
        var imgSrc = $(this).closest('.product-tile').find('img.tile-image').prop('src');
        productsForComparison = selectProduct(productsForComparison, pid, imgSrc);
        $(this).trigger('compare:selected', {
          pid: pid
        });
   ...
   */
  setBackUrl: function setBackUrl() {
   ...
   */
  setPushState: function setPushState() {
  ...
  catchFilterChange: function catchFilterChange() {
    $('.container').on('click', '.refinements li a, .refinement-bar a.reset', function (e) {
      e.preventDefault();
      clearCompareBar();
    });
  },
  listenToFilterChange: function listenToFilterChange() {
