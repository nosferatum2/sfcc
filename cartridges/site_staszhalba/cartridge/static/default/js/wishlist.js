...
var base = __webpack_require__(/*! lyonscg/product/base */ "./cartridges/app_lyonscg/cartridge/client/default/js/product/base.js");
...
module.exports = {
  ...
  initEditWishlistProductModal: function initEditWishlistProductModal() {
      ...
      $.ajax({
        ...
        success: function success(data) {
          ...
          data.results.hits.forEach(function (hit) {
            var divString = '<div class="row wl-hit">' + '<div class="text-left col-6">' + hit.firstName + ' ' + hit.lastName + '</div>' + '<div class="text-right col-6">' + '<a href="' + hit.url + '" title="' + hit.urlTitle + '" data-id="' + hit.id + '">' + hit.urlText + '</a>' + '</div>' + '<div class="text-left col-12">' + hit.email + '</div>' + '</div>';
