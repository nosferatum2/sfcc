        ...
        if (registrationForm.valid) {
            ...
            this.on('route:BeforeComplete', function (req, res) { // eslint-disable-line no-shadow
                ...
                if (registrationForm.validForm) {
                    ...
                    try {
                        if (registrationForm.form.customer.attachgithubinfo.checked) {
                            ...
                            if (serviceResponse.object.success !== true) {
                                ...
                                res.json({
                                    success: false,
                                    errorMessage: 'Github profile is not found'
                                });
                        ...
                        Transaction.wrap(function () {
                            ...
                            if (!authenticatedCustomer) {
                                ...
                                if (registrationForm.form.customer.attachgithubinfo.checked) {
                                    var githubInfoObj = {
                                        id: serviceResponse.object.data.user.id,// eslint-disable-line
                                        login: serviceResponse.object.data.user.login// eslint-disable-line
                                    };

                                    newCustomerProfile.custom.staszhalbaGithubUserJson = JSON.stringify(githubInfoObj);
                                }
                            }
                        });
                    } catch (e) {
